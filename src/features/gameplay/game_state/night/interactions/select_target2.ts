...
import { selectGameplayNightTarget2 } from "../../../../../global/types/interaction_states.js";
...
const select_night_target2_interaction: InteractionModule<StringSelectMenuInteraction, selectGameplayNightTarget2> = {
    interaction_name: 'select_gameplay_night_target2',
    states: {
        night: {
    ...
    entry: async function(interaction: StringSelectMenuInteraction): Promise<void> {
        console.log('interaction run: select_gameplay_night_target2');
        const clientId: string = interaction.user.id;
...
export default select_night_target2_interaction;