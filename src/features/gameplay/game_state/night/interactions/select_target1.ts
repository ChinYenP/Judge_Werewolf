...
import { selectGameplayNightTarget1 } from "../../../../../global/types/interaction_states.js";
...
const select_night_target1_interaction: InteractionModule<StringSelectMenuInteraction, selectGameplayNightTarget1> = {
    interaction_name: 'select_gameplay_night_target1',
    states: {
        night: {
            execute: async function (interaction: StringSelectMenuInteraction): Promise<void> {
                ...
                new_status.selecting.target1 = Number(interaction.values[0]);
    ...
    entry: async function(interaction: StringSelectMenuInteraction): Promise<void> {
        console.log('interaction run: select_gameplay_night_target1');
        const clientId: string = interaction.user.id;
...
export default select_night_target1_interaction;