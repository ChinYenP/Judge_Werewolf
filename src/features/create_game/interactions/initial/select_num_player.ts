...
import { selectCreateNumPlayer } from '../../../../global/types/interaction_states.js';
import { t_error_code, isNumPlayer } from '../../../../global/types/list_str.js';
...
const select_num_player_interaction: InteractionModule<StringSelectMenuInteraction, selectCreateNumPlayer> = {
    interaction_name: 'select_create_initial_num_player',
    states: {
        initial: {
    ...
    entry: async function(interaction: StringSelectMenuInteraction): Promise<void> {
        console.log('interaction run: select_create_initial_num_player');
        const clientId: string = interaction.user.id;
...
export default select_num_player_interaction;